...
with st.container():
    st.write("PawPal adalah boneka pintar interaktif berbasis IoT dan AI yang dirancang untuk mengurangi screen time dan mendorong interaksi bermakna bagi anak-anak. Menggunakan teknologi speech-to-text, natural language understanding, dan text-to-speech, PawPal berkomunikasi secara alami dalam Bahasa Indonesia. Dengan fitur pembelajaran adaptif, percakapan interaktif, dan permainan edukatif, PawPal mendukung perkembangan kognitif dan emosional anak melalui pengalaman bermain sambil belajar yang aman dan menyenangkan. Semua interaksi diproses melalui server cloud yang andal dan aman.")
...
with st.container():
    ...
    with col1:
        with st.expander("👄 Talk To Me"):
            st.write("Percakapan natural yang membantu anak mengekspresikan diri dan mengembangkan keterampilan sosial-emosional.")
        with st.expander("🖐️ Math Adventures"):
            st.write("Permainan pemecahan masalah interaktif yang membangun konsep dasar matematika melalui cerita yang seru.")
    with col2:
        with st.expander("🔤 Spelling Games"):
            st.write("Latihan mengeja yang dipandu suara untuk memperkuat kosakata dan pengenalan huruf.")
        with st.expander("❓ Would you Rather"):
            st.write("Pertanyaan ringan dan imajinatif yang mendorong pemikiran kritis dan kreativitas anak.")
...
with st.container():
    ...
    st.write("PawPal dirancang khusus untuk anak usia 4 hingga 8 tahun, dengan aktivitas yang sesuai usia untuk mendukung pembelajaran dan interaksi yang menyenangkan tanpa layar.")
...
with st.container():
    ...
    with col2:
        with st.container(border=True, height=110):
            st.write("Misalnya, jika Anda mengatur durasi 30 menit, maka PawPal akan berinteraksi selama total 30 menit, terbagi dalam sesi yang Anda tentukan.")
...
with st.container():
    ...
    with col1:
        with st.container(border=True, height=160):
            # st.write("")
            st.write("Sesi menentukan berapa jenis aktivitas berbeda yang akan dimainkan PawPal dalam satu periode.")
    with col2:
        with st.container(border=True, height=160):
            st.markdown(
                "Contoh, "
...
with st.container():
    ...
    st.write("Tentu saja! Anda bisa memilih dan mengatur kombinasi fitur berdasarkan jumlah sesi yang diinginkan, sesuai mood, kebiasaan, atau perkembangan anak Anda.")
