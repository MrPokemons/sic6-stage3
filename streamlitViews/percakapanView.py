...
from src.controllers.pawpal import StartConversationInput, TopicParams, TopicFlowType
...
with st.form("child_profile_form"):
    ...
    genderInput = st.selectbox("🚻 Jenis Kelamin", ["Pilih Jenis Kelamin", "Laki-laki", "Perempuan"])
